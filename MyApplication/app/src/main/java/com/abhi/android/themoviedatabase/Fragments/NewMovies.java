...
public class NewMovies extends Fragment implements LoaderManager.LoaderCallbacks<String> {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener(){
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!loading && (totalItemCount - visibleItemCount) <= (firstVisibleItem + visibleThreshold)) {
                    String url = TinyUrls.new_movies + Utils.API_KEY + "&language=en-US" + "&page=" + String.valueOf(pageCount);
                    executeLoader("movies", url, TOP_MOVIE_LOADER);
                    loading = true;
                }
